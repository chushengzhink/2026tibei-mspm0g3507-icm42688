...
#define Q3_MINUS_HIGH_SPEED_BRAKE_SPEED_CM_S (6.0f)
#define Q3_MINUS_HIGH_SPEED_BRAKE_STOP_CM  (-3.20f)
...
#define Q3_FINAL_CAPTURE_MS                (80U)
#define Q3_FINAL_CAPTURE_DEADLINE_WINDOW_MS (120U)
#define Q3_FINAL_CAPTURE_CONFIRM_GRACE_CM  (0.15f)
#define Q3_FINAL_CAPTURE_CONFIRM_GRACE_SPEED_CM_S (0.35f)
#define Q3_FINAL_CAPTURE_DEADLINE_ASSIST_BASE_US (24.0f)
#define Q3_FINAL_CAPTURE_DEADLINE_ASSIST_POSITION_GAIN_US_PER_CM (12.0f)
#define Q3_FINAL_CAPTURE_DEADLINE_ASSIST_URGENCY_GAIN_US (30.0f)
