...
#define ML_PWM_TIMA1_CH1_PORT            GPIOB
#define ML_PWM_TIMA1_CH1_PIN             DL_GPIO_PIN_27
#define ML_PWM_TIMA1_CH1_IOMUX           IOMUX_PINCM58
#define ML_PWM_TIMA1_CH1_FUNCTION        IOMUX_PINCM58_PF_TIMA1_CCP1

#define ML_SOFT_I2C_HALF_PERIOD_US       (2U)
#ifndef ML_OLED_I2C_HALF_PERIOD_US
#define ML_OLED_I2C_HALF_PERIOD_US       ML_SOFT_I2C_HALF_PERIOD_US
#endif
